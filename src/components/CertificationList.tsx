...
function IssuerIcon({ issuer }: { issuer: CertificationStructure["issuer"] }) {
  ...
  // The eight-bar IBM mark, from Simple Icons v11 (react-icons no longer
  // ships it). IBM blue, lightened in dark mode by the class below.
  return (
    <svg aria-hidden="true" viewBox="0 7 24 10" className="h-auto w-8 ibm-mark" fill="currentColor">
