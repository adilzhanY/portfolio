/*
 * LogoLoop — infinite logo marquee from reactbits.dev, ported to TypeScript.
 * Velocity-smoothed rAF loop over duplicated sequences; hover can pause or
 * decelerate; optional edge fade and hover scaling. Reduced motion freezes
 * the track via CSS.
 */
import {
  useCallback,
